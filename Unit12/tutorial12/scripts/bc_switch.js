...
function setupStyles() {
	...
	pageStyle.setAttribute("disabled", "disabled"); //disable stylesheet, but not recognized by firefox
	
	// Append the link element to thee document head
	document.head.appendChild(pageStyle);
	pageStyle.disabled = true; //disable stylesheet for firefox
